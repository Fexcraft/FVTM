 ...
 */
public class ConstRenderer implements BlockEntityRenderer<ConstructorEntity, BlockEntityRenderState> {
	...
	public void submit(BlockEntityRenderState state, PoseStack pose, SubmitNodeCollector nodecoll, CameraRenderState camera){
		...
		if(MODEL != null) RENDER_UTIL.render(MODEL, DefaultModel.RENDERDATA_BLANK);
