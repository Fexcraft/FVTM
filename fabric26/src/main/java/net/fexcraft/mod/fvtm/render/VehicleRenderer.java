...
public class VehicleRenderer {
	...
	public static void renderVehicles(LevelRenderContext context){
		...
		for(Map.Entry<V3D, JackEntity> entry : JACKS.entrySet()){
			...
			//
			Renderer26.light = LevelRenderer.getLightCoords(Minecraft.getInstance().level, jack.getBlockPos());
			pose.pushPose();
