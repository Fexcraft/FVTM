...
public class G_4x4ROT_TE extends BlockBase {
    ...
    public void onBlockPlacedBy(World world, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack){
        ...
        world.setBlockState(pos, state.withProperty(VARIANTS4, stack.getMetadata()).withProperty(FACING, type.isRandomRot() ? EnumFacing.HORIZONTALS[Static.random.nextInt(4)] : placer.getHorizontalFacing().getOpposite()), 2);
    }
