...
import static net.fexcraft.mod.fvtm.handler.TireInstallationHandler.TireData;
...
public class PartItemModel implements FCLItemModel {
	...
	public void renderItem(TransformType type, ItemStack item, EntityLivingBase entity){
		...
		model.render(DefaultModel.RENDERDATA.set(null, null, data, null, Minecraft.getMinecraft().getRenderPartialTicks()));
		GL11.glPopMatrix();
	}
