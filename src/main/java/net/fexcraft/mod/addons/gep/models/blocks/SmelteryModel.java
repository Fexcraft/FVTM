...
public class SmelteryModel extends BlockModel {
	...
	private TurboList body, left, righ;
    ...
    public SmelteryModel(){
        ...
        this.add("right", right); this.righ = this.get("right");
        //
        ...
        this.add("left", left); this.left = this.get("left");
    }
    
    private float quarterrad = net.fexcraft.lib.common.Static.rad1 / 4;
	...
	public void render(BlockData data, BlockTileEntity key, VehicleEntity ent, int meta){
		...
		if(data.getScript() != null && key != null){
	    	...
	    	//
	    	left.rotate(0, quarterrad * angle, 0);
	        left.render(null, null, null);
	    	left.rotate(0, quarterrad * -angle, 0);
	    	righ.rotate(0, quarterrad * -angle, 0);
	        righ.render(null, null, null);
	    	righ.rotate(0, quarterrad * angle, 0);
		}
		else{
	        left.render(null, null, null); righ.render(null, null, null);
		}
	}
