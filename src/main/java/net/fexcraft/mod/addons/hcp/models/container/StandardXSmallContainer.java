 ...
 */
@fModel(registryname = "hcp:models/container/xsmall") //TODO adjust as needed
public class StandardXSmallContainer extends ContainerModel {

	public StandardXSmallContainer(){
