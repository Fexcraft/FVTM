...
@fModel(registryname = "test:models/container/tiny")
public class GenericTiny extends ContainerModel {
    ...
    public GenericTiny(){
        ...
        body[0].addBox(0F, 0F, 0F, 16, 48, 48, 0F); // Box 1
        body[0].setRotationPoint(-8F, -48F, -24F);
