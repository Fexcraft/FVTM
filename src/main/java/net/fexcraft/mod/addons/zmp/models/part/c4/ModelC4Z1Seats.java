...
public class ModelC4Z1Seats extends PartModel {
    ...
    public ModelC4Z1Seats(){
        ...
        this.addToCreators("FEX___96"); this.addToCreators("zackyboy18");
        ...
        body[1].rotationAngleZ = Static.toDegrees(0.06981317F);
        ...
        body[8].rotationAngleZ = Static.toDegrees(0.06981317F);
        ...
        body[10].rotationAngleZ = Static.toDegrees(0.06981317F);
        body[11].addBox(0F, -5F, 1.5F, 2, 3, 8, 0F); // Box 482
        body[11].setRotationPoint(34F, -25.5F, -20F);
        body[11].rotationAngleZ = Static.toDegrees(0.06981317F);
        ...
        body[14].rotationAngleZ = Static.toDegrees(0.06981317F);
        body[15].addBox(0F, 0F, 0F, 2, 12, 10, 0F); // Box 486
        body[15].setRotationPoint(34F, -25.5F, -9F);
        body[15].rotationAngleZ = Static.toDegrees(0.06981317F);
        ...
        this.add("body", body); super.fixRotations(get("body")); this.get("body").addProgram(DefaultPrograms.RGB_SECONDARY);
    }
