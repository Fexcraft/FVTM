...
public class FVTM {
	...
	public static final String VERSION = "3.7.62";
	...
	public void init(FMLInitializationEvent event){
		...
		if(event.getSide().isClient()){
			...
			StreetSignItem.INSTANCE.setCreativeTab(InternalAddon.INSTANCE.getDefaultCreativeTab());
			TrafficSignItem.INSTANCE.setCreativeTab(InternalAddon.INSTANCE.getDefaultCreativeTab());
