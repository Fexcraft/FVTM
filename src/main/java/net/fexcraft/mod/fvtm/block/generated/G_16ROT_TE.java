...
public class G_16ROT_TE extends BlockBase {
    ...
    public void onBlockPlacedBy(World world, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack){
        ...
        world.setBlockState(pos, state.withProperty(ROTATION, type.isRandomRot() ? Static.random.nextInt(16) : MathHelper.floor((double)((placer.rotationYaw + 180.0F) * 16.0F / 360.0F) + 0.5D) & 15), 2);
    }
