...
public class TrainsModEntityConverter extends EntityRailcar implements IPacketReceiver<PacketEntityUpdate> {
	...
	public TrainsModEntityConverter(World world){
		super(world); Print.debug(this, world.isRemote); //setup();
	...
	public TrainsModEntityConverter(World world, BlockPos pos, VehicleData data){
		super(world, pos); this.data = data; setup(); Print.debug(this, world.isRemote);
	}
	...
	public void processClientPacket(PacketEntityUpdate pkt){
		Print.console(pkt.nbt); this.readFromNBT(pkt.nbt); this.setup(); Print.console(this, world.isRemote);
	}
	...
	public void onUpdate(){
		...
		if(!world.isRemote && !sync){
			Print.console("sending"); sync = true;
	...
	protected void writeEntityToNBT(NBTTagCompound compound){
		...
		if(data != null) data.writeToNBT(compound);
	}
