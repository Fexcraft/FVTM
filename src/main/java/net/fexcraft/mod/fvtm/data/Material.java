...
public class Material extends TypeCore<Material> implements Tabbed, ItemTextureable {
	...
	public Material parse(JsonObject obj){
		...
		// moved to registry event // this.item = new MaterialItem(this);
		//TODO type eventsMinecraftForge.EVENT_BUS.post(new TypeEvents.MaterialCreated(this, obj));
		return this;
	}
	...
	public void linkContainerItem(){
		...
		//TODO item container material // this.item.setContainerItem(Item.getByNameOrId(this.container));
	}
	...
	public void registerIntoOreDictionary(){
        //TODO oredict material // if(getOreDictionaryId() != null) OreDictionary.registerOre(getOreDictionaryId(), item); else return;
	}
