    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY){
        ...
        if(mode == Modes.MAIN){
            ...
            if(addon != null){
                ...
                listbuttons[0][0].enabled = false;
                listbuttons[0][1].enabled = false;
            }
            //1
            id++;
            addon = id >= addons.size() ? null : addons.get(id);
            if(addon != null){
                ...
                listbuttons[1][0].enabled = false;
                listbuttons[1][1].enabled = false;
            }
            //2
            id++;
            addon = id >= addons.size() ? null : addons.get(id);
            if(addon != null){
                ...
                listbuttons[2][0].enabled = false;
                listbuttons[2][1].enabled = false;
            }
            //3
            id++;
            addon = id >= addons.size() ? null : addons.get(id);
            if(addon != null){
                ...
                listbuttons[3][0].enabled = false;
                listbuttons[3][1].enabled = false;
            }
        }
