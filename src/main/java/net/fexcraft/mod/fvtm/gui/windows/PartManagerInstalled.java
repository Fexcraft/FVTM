...
public class PartManagerInstalled implements Window {
    ...
    public void addButtons(ConstructorMainGUI gui, List<GuiButton> buttonList){
        ...
        b0.setTexture(texture);
        b0.setTexturePos(0, 2, 2);
        b0.setTexturePos(1, 2, 2);
        ...
        b1.setTexturePos(0, 77, 2);
        b1.setTexturePos(1, 77, 2);
        ...
        b2.setTexturePos(0, 152, 2);
        b2.setTexturePos(1, 152, 2);
