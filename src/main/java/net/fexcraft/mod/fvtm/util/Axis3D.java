...
/** Earlier "VehicleAxe", based on Flansmod's RotatedAxes. */
public class Axis3D {
    ...
    public Axis3D(Matrix4f mat){ matrix = mat; convertMatrixToAngles(); }

    public Axis3D(float yaw, float pitch, float roll){ setAngles(yaw, pitch, roll); }
    ...
    public void copy(Axis3D axes){
        this.yaw = axes.yaw; this.roll = axes.roll; this.pitch = axes.pitch;
    }
    ...
    public Vector3f getYAxis(){ return new Vector3f(matrix.m01, matrix.m11, matrix.m21); }

    public Vector3f getZAxis(){ return new Vector3f(-matrix.m02, -matrix.m12, -matrix.m22); }
