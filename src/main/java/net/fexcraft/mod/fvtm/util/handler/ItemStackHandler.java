...
public class ItemStackHandler extends net.minecraftforge.items.ItemStackHandler {
    ...
    private Object container;//TODO

    public ItemStackHandler(NonNullList<ItemStack> inventory){
        super(inventory); this.container = null;
    }

    public ItemStackHandler(Object container, NonNullList<ItemStack> inventory){
    ...
    public ItemStack insertItem(int slot, @Nonnull ItemStack stack, boolean simulate){
        if(stack.getItem() instanceof VehicleItem || /*stack.getItem() instanceof ContainerItem //TODO||*/ isContainerPart(stack) || !isValid(stack)){
            return stack;
        }
    ...
    private boolean isValid(ItemStack stack){
        return container == null ? true : true;//TODO container.isItemValid(stack);
    }
